export const metadata = {
  title: 'The mental model: High agency - Isaac Almanza',
  description: 'Exploring the concept of high agency: what it means to be unstoppable, create your own reality, and get things done regardless of circumstances.',
};

# The mental model: High agency

_10 March 2021 / 2 min read_
