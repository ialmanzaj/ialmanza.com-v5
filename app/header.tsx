    ...
    <header className="mb-8 flex items-center justify-between">
      <div>
          ...
          >
            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              <g className="fill-black dark:fill-white">
                <g
                  transform="translate(2550.000000, 4.000000)"
                  fillRule="nonzero"
                >
                  <g transform="translate(301.500000, 356.500000) scale(-1, 1) rotate(-180.000000) translate(-301.500000, -356.500000) ">
                    <path
                ...
                <g
                  transform="translate(255.000000, 1.000000)"
                  fillRule="nonzero"
                >
                  <g transform="translate(232.500000, 358.000000) scale(-1, 1) rotate(-180.000000) translate(-232.500000, -358.000000) ">
                    <path
                ...
                <polygon points="0 0 134.880512 83.5592434 135 716 0 716"></polygon>
                <g transform="translate(820.000000, 0.000000)">
                  <path
        ...
        <TextEffect
          ...
          preset="fade"
          per="char"
          className="pt-4 text-zinc-600 dark:text-zinc-500"
          delay={0.5}
        >
